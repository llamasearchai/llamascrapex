# Contributing to LlamaScrapex

Thank you for your interest in contributing to LlamaScrapex! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaScrapex:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamascrapex.git
   cd llamascrapex
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamascrapex.git
   ```
...
By contributing to LlamaScrapex, you agree that your contributions will be licensed under the project's MIT License.
